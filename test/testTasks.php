...
function test_HamtaAllaUppgifterDatum(): string {
    ...
    if($svar->getStatus()===400) {
        ...
        $retur .= "<p class='ok'>Hämta fel ordning på datum gav {$svar->getStatus()}"
        . "istället för förväntat svar 400</p>";
    }
...
function test_SparaUppgift(): string {
    ...
    $svar=sparaNyUppgift($postdata);
    if($svar->getStatus()===400) {
        $retur .="<p class='ok'>Spara ny uppgift misslyckadess som förväntat (date = imorgon)</p>";
    } else {
    ...
    $svar=sparaNyUppgift($postdata);
    if($svar->getStatus()===400) {
        $retur .="<p class='ok'>Spara ny uppgift misslyckadess som förväntat (felaktigt datumformat)</p>";
    } else {
    ...
    $svar=sparaNyUppgift($postdata);
    if($svar->getStatus()===400) {
        $retur .="<p class='ok'>Spara ny uppgift misslyckadess som förväntat (datum saknas)</p>";
    } else {
    ...
    $svar=sparaNyUppgift($postdata);
    if($svar->getStatus()===400) {
        $retur .="<p class='ok'>Spara ny uppgift misslyckadess som förväntat (felaktig tid 12:00)</p>";
    } else {
    ...
    $svar=sparaNyUppgift($postdata);
    if($svar->getStatus()===400) {
        $retur .="<p class='ok'>Spara ny uppgift misslyckadess som förväntat (felaktig tidsformat)</p>";
    } else {
    ...
    $svar=sparaNyUppgift($postdata);
    if($svar->getStatus()===400) {
        $retur .="<p class='ok'>Spara ny uppgift misslyckadess som förväntat (tid saknas)</p>";
    } else {
    ...
    if($svar->getStatus()===400) {
        ...
        $retur .= "<p class='error'>Spara ny uppgift utan activityId (-1) "
        . "returnerade {$svar->getStatus()} istället för förväntat 400</p>";
    }
    $db->rollBack();
    ...
    if($svar->getStatus()===400) {
        ...
        $retur .= "<p class='error'>Spara ny uppgift utan activityId (100) "
        . "returnerade {$svar->getStatus()} istället för förväntat 400</p>";
    }
    $db->rollBack();
...
function test_RaderaUppgift(): string {
    ...
    $svar=sparaNyUppgift($postData);
    if($svar->getStatus()!==200){
        throw new Exception("Kunder inte skapa ny post, testerna avbryts!");
    }
